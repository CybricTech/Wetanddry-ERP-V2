...
Without these, `updateTruckMileage` writes a value backed by no record or fuel log, and the next
...
(`src/lib/actions/fuel.ts:153`) and feed efficiency calculations. Recomputing from maintenance
